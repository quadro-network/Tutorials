...
echo '=============== SETUP FINISHED ==================='
echo -e 'View the logs from the running service:: sudo journalctl -u initiad -f -o cat'
echo -e "Check the node is running: sudo systemctl status initiad.service"
echo -e "Stop your avail node: sudo systemctl stop initiad.service"
echo -e "Start your avail node: sudo systemctl start initiad.service"