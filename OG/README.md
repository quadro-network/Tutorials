...
<p align="center">
  <img height="100" height="auto" src="https://github.com/quadro-network/Tutorials/blob/main/content/oglogo.png">
</p>
...
```
wget -O og-auto.sh https://raw.githubusercontent.com/quadro-network/Cosmos_tutorials/main/OG/og-auto.sh && chmod +x og-auto.sh && ./og-auto.sh
```
